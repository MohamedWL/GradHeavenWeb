...
export const getUserJobs = async (req, res) => {
    try {
        ...
        const formattedJobs = jobs.map(
            ({ _id, jobCompany, jobTitle, jobDescription, aboutUs, requirements, otherSkills, expirationDate, picturePath }) => {
                return { _id, jobCompany, jobTitle, jobDescription, aboutUs, requirements, otherSkills, expirationDate, picturePath };
            }
        );
